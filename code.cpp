...
public:
    ...
    void cabDetails()
    {
        ...
        cout << "-----------ABC Cabs-----------\n" << endl;
        cout << "1. Rent a Standard Cab - TK.30 for 1KM" << endl;
        cout << "2. Rent a Luxury Cab - TK.50 per 1KM" << endl;
...
public:
    ...
    void hotels()
    {
        string hotelNo[] = {"Paradise Inn", "Peninsula", "ElephantBay"};
        for(int a = 0; a < 3; a++)
        {
        ...
        if(choiceHotel == 1){
            ...
            cout << "\tLive a Luxury at Paradise Inn: TK.15000.00" << endl;
            ...
            if (packChoice1 == 1){
                hotelCost = 5000.00;
                cout << "\nYou have successfully booked Standard Pack at Paradise Inn" << endl;
                cout << "Goto Menu and take the receipt" << endl;
            }
            else if (packChoice1 == 2){
                hotelCost = 10000.00;
                cout << "\nYou have successfully booked Premium Pack at Paradise Inn" << endl;
                cout << "Goto Menu and take the receipt" << endl;
            }
            else if (packChoice1 == 3){
                hotelCost = 15000.00;
                cout << "\nYou have successfully booked Luxury Pack at Paradise Inn" << endl;
                cout << "Goto Menu to take the receipt" << endl;
            }
            else{
                cout << "Invalid Input! Redirecting to Previous Menu \nPlease Wait!" << endl;
            ...
            if (packChoice1 == 1){
                hotelCost = 15000.00;
                cout << "You have successfully booked Family Pack at Peninsula" << endl;
                cout << "Goto Menu and take the receipt" << endl;
            }
            else if (packChoice1 == 2){
                hotelCost = 10000.00;
                cout << "You have successfully booked Couple Pack at Peninsula" << endl;
                cout << "Goto Menu and take the receipt" << endl;
            }
            else if (packChoice1 == 3){
                hotelCost = 5000.00;
                cout << "You have successfully booked Single Pack at Peninsula" << endl;
                cout << "Goto Menu and take the receipt" << endl;
            }
            else{
                cout << "Invalid Input! Redirecting to Previous Menu \nPlease Wait!" << endl;
            ...
            cout << "Set in tropical gardens on the banks of the Chitra river While Seeing Elephants" << endl;
...
public:
    ...
    void printBill()
    {
        ...
        {
            outf << "--------Fusion Travel Agency--------" << endl;
            outf << "-------------Receipt-------------" << endl;
